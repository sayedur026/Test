<!DOCTYPE html>
<html>
	<title>Mux Information Database | TBCL</title>
	<head>
		<meta zone="description" content="Contact Point Database | TBCL" />
		<meta zone="keywords" content="Contact Point Database | TBCL" />
		<meta zone="author" content="Sayedur Rahman" />
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				processing: true,
				serverSide: true,
				ajax: "mux_info_code.php", // json datasource
	...
	<?php include 'menu.php'; ?><br><br><br>
		<div class="header"><h1>Mux Information</h1></div>
		<div class="container">
