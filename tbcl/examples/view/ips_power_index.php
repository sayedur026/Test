<!DOCTYPE html>
<html>
	<title>IPS Power Information Database | TBCL</title>
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				processing: true,
				serverSide: true,
				ajax: "ips_power_code.php", // json datasource
	...
	<?php include 'menu.php'; ?><br><br><br>
		<div class="header"><h1>IPS Power Information</h1></div>
		<div class="container">
